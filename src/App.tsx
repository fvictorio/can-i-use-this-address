  ...
  return (
    <>
      <div className="App" style={{ marginBottom: "2rem" }}>
        ...
        <p>
          It goes without saying: this list is not exhaustive. An address marked as "safe" could still be compromised.
          But you can be pretty sure that an address marked as not safe shouldn't be used in mainnet.
        </p>
      </div>
      <Footer />
    </>
